...
export const mockSubjects: Subject[] = [
  ...
  {
    id: 's11',
    title: 'Complete Java Programming: Enterprise Edition',
    description: 'Master Java from basics to enterprise development. Build Spring Boot applications, microservices, and REST APIs.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=600&h=340&fit=crop',
    category: 'Programming',
    instructor: 'Dr. Sarah Chen',
    totalLessons: 24,
    ...
    whatYouWillLearn: [
      ...
      'Spring Boot and Spring MVC framework',
      'Build REST APIs with Spring',
      'Database integration with JPA/Hibernate',
      'Unit testing with JUnit and Mockito',
      'Deploy Java apps to production',
    ],
    requirements: ['No prior Java experience needed', 'Basic understanding of programming concepts'],
    language: 'English',
    lastUpdated: '2026-03-01',
  },
  {
    id: 's12',
    title: 'Blockchain & Web3 Development with Solidity',
    description: 'Learn blockchain fundamentals, smart contract development with Solidity, and build decentralized applications (DApps).',
    thumbnailUrl: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=600&h=340&fit=crop',
    category: 'Web3',
    instructor: 'Mark Rivera',
    totalLessons: 18,
    ...
    whatYouWillLearn: [
      ...
      'Build and deploy DApps with Hardhat',
      'ERC-20 and ERC-721 token standards',
      'DeFi protocols and NFT marketplaces',
      'Web3.js and Ethers.js integration',
    ],
    requirements: ['JavaScript programming knowledge', 'Basic understanding of web development'],
    language: 'English',
    lastUpdated: '2026-02-28',
  },
  {
    id: 's13',
    title: 'Digital Marketing Masterclass: SEO, Ads & Analytics',
  ...
  {
    id: 's14',
    title: 'TypeScript Mastery: Advanced Patterns & Best Practices',
    description: 'Deep dive into TypeScript with generics, utility types, design patterns, and building type-safe applications at scale.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=600&h=340&fit=crop',
    category: 'Programming',
    instructor: 'Dr. Aisha Patel',
    totalLessons: 16,
    ...
    whatYouWillLearn: [
      ...
      'Type-safe API layers and validation',
      'Monorepo setups with TypeScript',
      'Performance optimization techniques',
    ],
    requirements: ['Solid JavaScript knowledge', 'Basic TypeScript experience'],
    language: 'English',
